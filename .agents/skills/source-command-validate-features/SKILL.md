---
name: "source-command-validate-features"
...
# source-command-validate-features

Use this skill when the user asks to run the migrated source command `validate-features`.
