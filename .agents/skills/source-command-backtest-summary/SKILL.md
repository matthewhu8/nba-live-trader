---
name: "source-command-backtest-summary"
...
# source-command-backtest-summary

Use this skill when the user asks to run the migrated source command `backtest-summary`.
