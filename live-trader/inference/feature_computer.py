...
if TYPE_CHECKING:
    ...
    from inference.possession_builder import PossessionRow
...
class FeatureComputer:
    ...
    def _compute_context(possession: "PossessionRow", state: "GameState") -> dict[str, float]:
        ...
        return {
            ...
            "home_sub_count":                 0.0,  # TODO: track per-game
            "away_sub_count":                 0.0,  # TODO: track per-game
...
def _possessions_since_last_timeout(state: "GameState") -> int:
    if not state.timeouts:
        return 999
    # TODO: compute based on state.possession_count and last timeout's possession index
    return 999


def _timeout_in_last_3(state: "GameState", possession_id: int) -> tuple[bool, bool]:
    # TODO: check if home/away called timeout in last 3 possessions
    return False, False
